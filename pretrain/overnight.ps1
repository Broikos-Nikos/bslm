...
for ($i = 1; $i -le 30; $i++) {
  ...
  & ".venv\Scripts\python.exe" -m pretrain.train --name $name --size 56m --tokens 1.2e9 --micro 8 --resume --eval_every 100 --ckpt_every 150 2>&1 | Out-File -Append -Encoding utf8 $log
